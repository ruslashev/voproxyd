...
{
    log("bridge_cmd_pan_tilt_directionals: % d, % d, (pan %d, tilt %d)", vert, horiz, pan_speed, tilt_speed);
}

void bridge_cmd_pan_tilt_relative_move(uint8_t speed, uint8_t p[5], uint8_t t[4])
{
    log("bridge_cmd_pan_tilt_relative_move: %d,", speed);
    log_p5t4(p, t);
}

void bridge_cmd_pan_tilt_absolute_move(uint8_t speed, uint8_t p[5], uint8_t t[4])
{
    log("bridge_cmd_pan_tilt_absolute_move: %d,", speed);
    log_p5t4(p, t);
}
